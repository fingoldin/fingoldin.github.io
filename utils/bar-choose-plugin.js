...
//console.log($(vals[0]).data("value"));
			...
			{
				console.log(parseInt($(vals[i]).data("offby")));
...
//console.log(res);
		...
		else if(type == "show")
		{
			...
			console.log(acols.length + " " + data.answers.length + " " + ccols.length);
			...
			//	var e = Math.abs(a - data.answers[i]) / data.answers[i];
			//	error += e;
			...
			//console.log($(root).data("max_val"));

			//var error = Math.round(100 * diff / maxdiff);
			var error = Math.round(100 * diff / $(root).data("max_val"));

			//error = Math.min(Math.round(100 * error / data.answers.length), 100);

			if(error === 0)
				mes = "Amazing! You were dead right";
			else if(error < 40)
				mes = "Nice! You were off by " + error + " percent";
			else
				mes = "You were off by " + error + " percent";
